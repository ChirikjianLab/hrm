...
face = SuperEllipse([5,3,1,0,0,0,50], 'g', infla);
...
elseif opt == 2
    earL = SuperEllipse([3,1.5,1,-5,3,3/4*pi,50], 'b', infla);
    earR = SuperEllipse([3,1.5,1,5,3,1/4*pi,50], 'b', infla);
...
% S-shape robot, rigid
elseif opt == 3
    base = SuperEllipse([3,1,1,0,0,0,50], 'b', infla);
    link1 = SuperEllipse([3,1,1,-3,3,pi/2,50], 'b', infla);
    link2 = SuperEllipse([3,1,1,0,6,0,50], 'b', infla);
    link3 = SuperEllipse([3,1,1,3,-3,pi/2,50], 'b', infla);
    link4 = SuperEllipse([3,1,1,0,-6,0,50], 'b', infla);
...
elseif opt == 4
    base = SuperEllipse([25/2,35/2,1,0,0,0,50], 'g', infla);
