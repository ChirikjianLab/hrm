# * Find CGAL Find the CGAL includes and client library This module defines
#   CGAL_INCLUDE_DIR, where to find CGAL.h CGAL_LIBRARIES, the libraries needed
#   to use CGAL. CGAL_FOUND, If false, do not try to use CGAL.

if(CGAL_INCLUDE_DIR
   AND CGAL_LIBRARIES
   AND BOOST_THREAD_LIBRARIES
   AND GMP_LIBRARIES)
  set(CGAL_FOUND TRUE)
  ...
  if(CGAL_INCLUDE_DIR
    ...
    message(
      STATUS
        "Found CGAL: ${CGAL_INCLUDE_DIR}, ${CGAL_LIBRARIES}, ${BOOST_THREAD_LIBRARIES}, ${GMP_LIBRARIES}"
      )
