...
class PRMtester {
  ...
  private:
    ...
    bool checkSeparation(SuperEllipse robot_, SuperEllipse obs_) const {
        ...
        Vector2d r_j_;
        r_j_ << obs_.a[4], obs_.a[5];
        bool res = robot_.fcl_separation(coeff_canon_i_, coeff_canon_j_, r_i_,
                                         r_j_, robot_.a[2], obs_.a[2]);
        /*if(res){
        std::cout<<"True"<<std::endl;
      }else{
        std::cout<<"False"<<std::endl;
    ...
    bool checkSeparationArena(SuperEllipse robot_, SuperEllipse arena_) const {
        ...
        Vector2d r_j_;
        r_j_ << arena_.a[4], arena_.a[5];
        bool aux = robot_.fcl_separation(coeff_canon_i_, coeff_canon_j_, r_i_,
                                         r_j_, robot_.a[2], arena_.a[2]);
        if (aux == true) {
            res = false;
        }
        return res;
