...
int main(int argc, char **argv) {
    ...
    outfile.open("time_fcl_sq.csv", std::ios_base::app);
    //    outfile <<
    //    "PLANNER,SUCCESS,TOTAL_TIME,ASTAR_TIME,CONST_TIME,RANDOM_CONF,GRAPH_NODES,GRAPH_EDGES,PATH_CONFIG,VALID_SPACE\n";
    outfile << "PLANNER,SUCCESS,TOTAL_TIME,GRAPH_NODES,GRAPH_EDGES,PATH_CONFIG,"
               "VALID_SPACE\n";
    outfile.close();
