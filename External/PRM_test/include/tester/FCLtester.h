...
class FCLtester: public Tester2D{
  public:
    FCLtester(double lowBound, double highBound, std::vector<SuperEllipse> arena_, std::vector<SuperEllipse> robot_, std::vector<SuperEllipse> obs_, int id) : Tester2D(lowBound, highBound, arena_, robot_, obs_, id){};
