#ifndef IS_ACS_MB_TESTER_H
#define IS_ACS_MB_TESTER_H
...
class ACSmbtester: public Tester2D{
  public:
    ACSmbtester(double lowBound, double highBound, std::vector<SuperEllipse> arena_, std::vector<SuperEllipse> robot_, std::vector<SuperEllipse> obs_, int id) : Tester2D(lowBound, highBound, arena_, robot_, obs_, id){}
