...
vector<Interval> interval::Complement(vector<Interval> &outer,
                                      vector<Interval> &inner) {
...
// int main(){
//    vector<Interval> arr = {{2,3},{1,1.3},{2.5,7},{5,7},{8.9,10}}, arr2 =
//    {{0,15},{0.3,13},{6,12}}; vector<Interval> arr_merge, arr_inter, arr_comp;
